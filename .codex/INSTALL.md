# AI Bounty Claim Bootstrap For Codex

Use this file as a bootstrap entry for Codex. The canonical instructions live in `SKILL.md` at the repository root.
...
3. If your local Codex setup supports a project-local skill workflow, make this repository available locally. Otherwise continue directly from the repository files.
